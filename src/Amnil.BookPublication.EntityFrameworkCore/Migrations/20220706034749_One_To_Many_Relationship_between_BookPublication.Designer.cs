...
{
    [DbContext(typeof(BookPublicationDbContext))]
    [Migration("20220706034749_One_To_Many_Relationship_between_BookPublication")]
    partial class One_To_Many_Relationship_between_BookPublication
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Amnil.BookPublication.Books.Book", b =>
                {
                    b.Property<Guid>("Id")
            ...
            modelBuilder.Entity("Amnil.BookPublication.Publications.Publication", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<DateTime>("PublicationEstablishedDate")
                        .HasColumnType("datetime2");

                    b.HasKey("Id");

                    b.ToTable("AppPublication", (string)null);
                });
            ...
            modelBuilder.Entity("Amnil.BookPublication.Books.Book", b =>
                {
                    b.HasOne("Amnil.BookPublication.Publications.Publication", null)
                        .WithMany("Books")
                        .HasForeignKey("PublicationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Amnil.BookPublication.Publications.Publication", "Publication")
                        .WithMany()
